...
class GoldenEvaluationService {
    async evaluateGoldenBaselineGate(params) {
        ...
        if (evalExecResult && fs_1.default.existsSync(evalExecResult.evaluationMetricsFilePath)) {
            try {
                const metricsFileContent = JSON.parse(fs_1.default.readFileSync(evalExecResult.evaluationMetricsFilePath, 'utf-8'));
